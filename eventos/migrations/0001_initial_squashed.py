...
class Migration(migrations.Migration):
    ...
    replaces = [('eventos', '0001_initial_squashed_0009_auto_20220308_2155_squashed_0002_ingressotransfer'), ('eventos', '0002_auto_20220317_2230')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingressos_recebidos', to='eventos.participante')),
                ('ingresso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transferências', to='eventos.ingresso')),
                ('previous_owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingressos_transferidos', to='eventos.participante')),
            ],
            options={
